...
about: Report a bug or unexpected behavior while using the Bast Ble Board.
...
- Verify that it really is a board problem and not a hardware or software problem not related to Electronic Cats.
- **Avoid** to submit a GitHub issue for project troubleshooting.

Any feedback/suggestions should be discussed on the [feedback section](https://github.com/ElectronicCats/BastBLE/issues):
